...
public class DebugVariableTreeTableModel extends DefaultTreeModel //AbstractTreeTableModel 
    ...
    public void setDebugVariables(ArrayList<DebugVariable> debugVariables) {
        ...
        for (Object childNode : rootNode.getChildren()) {
            ...
            this.fireTreeNodesInserted(this, new Object[] {this.getRoot()}, new int[] {currentIndex}, new Object[] {childNode});
            ///
    ...
    private void insertNode(Object childNode) {
        ...
        for (Object fieldNode : ((VariableNode) childNode).getChildren()) {
            ...
            this.fireTreeNodesInserted(this, new Object[] {childNode}, new int[] {currentIndex2}, new Object[] {fieldNode});
            currentIndex2++;
    ...
    public Object getValueAt(Object node, int column) {
        if (node instanceof VariableNode) {
            ...
            if (column == 0) {
                return debugVariable.getVarName();
            }
            if (column == 1) {
                return debugVariable.getType();
            }
            if (column == 2) {
                return debugVariable.getValue();
            }
        }
