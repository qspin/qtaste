...
final class Person {
    ...
    public String toString() {
        return "Firstname: " + getFirstName() + " | Lastname: " + getLastName() + " | Age: " + getAge() + " | Adress: "
              + getAdress();
    }
    ...
    public void setLastName(StringProperty pLastName) {
        mLastName = pLastName;
    }

    public void setFirstName(StringProperty pFirstName) {
        mFirstName = pFirstName;
    }

    public void setAdress(StringProperty pAdress) {
        mAdress = pAdress;
    }

    public void setAge(IntegerProperty pAge) {
        mAge = pAge;
    }
}
