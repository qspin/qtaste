...
echo 
java -javaagent:$RECORDER_PATH/target/qtaste-recorder-deploy.jar$FILTER_PATH -cp testapi/target/qtaste-testapi-deploy.jar com.qspin.qtaste.sutuidemo.Interface || exit 1
