...
public interface Subtitler extends SingletonComponent {
	 ...
	 * Only one message is displayed in the same time. If a message is already displayed, it is replaced by the new one and the displayed timer reset to the given value. 
	 * @param subtitle The message to display.
