...
class TreeNodeSelector extends UpdateComponentCommander {
    ...
    protected void prepareActions() throws QTasteTestFailException {
        ...
        //
        //				for (int currentChildIndex = 0; currentChildIndex < treeModel.getChildCount(currentNode);
        // currentChildIndex++) {
        ...
        //		}
        //		else {
        //			throw new QTasteTestFailException("Invalid component class (expected: JTree, got: " + component.getClass()
        // .getName() + ").");
        //		}
    }
