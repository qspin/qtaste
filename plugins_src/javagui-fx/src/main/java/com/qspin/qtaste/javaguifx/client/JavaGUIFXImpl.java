 ...
 */
package com.qspin.qtaste.javaguifx.client;

import com.qspin.qtaste.javaguifx.JavaGUIFX;
...
public class JavaGUIFXImpl implements JavaGUIFX {
    ...
    public void requestFocus(String componentName) throws QTasteException {
        mProxy.requestFocus(componentName);
    }
    ...
    protected JavaGUIFX mProxy;
    protected JMXClient mClient;
    private static final String BEAN_NAME = "com.qspin.qtaste.javaguifx.server:type=JavaGUIFX";
    private static final Class<?> BEAN_INTERFACE = com.qspin.qtaste.javaguifx.JavaGUIFX.class;
